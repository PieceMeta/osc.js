...
!function(i, a) {
    ...
    !function() {
        ...
        }, l.Long = void 0 !== n ? n : l.isNode ? require("long") : void 0, l.dataView = function(e, t, r) {
    ...
    l = l || require("./osc.js"), r = r || require("events").EventEmitter;
    !function() {
        "use strict";
        ...
        var e = l.Port.prototype = Object.create(r.prototype);
        e.constructor = l.Port, e.send = function(e) {
            ...
            t.useSLIP = void 0 === t.useSLIP || t.useSLIP;
            var r = t.useSLIP ? this.decodeSLIPData : this.decodeOSC;
        ...
        }, (e = l.Relay.prototype = Object.create(r.prototype)).constructor = l.Relay, e.open = function() {
